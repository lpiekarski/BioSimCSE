...
class CLTrainer(Trainer):
    ...
    def train(self, model_path: Optional[str] = None, trial: Union["optuna.Trial", Dict[str, Any]] = None):
        ...
        if hasattr(self, "sharded_dpp") and self.sharded_dpp:
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (step + 1) % self.args.gradient_accumulation_steps == 0 or (
                    ...
                    # Gradient clipping
                    if self.args.max_grad_norm is not None and self.args.max_grad_norm > 0 and hasattr(self, "deepspeed") and not self.deepspeed:
                    ...
                    elif self.use_cuda_amp or self.use_cpu_amp:
                    ...
                    self._maybe_log_save_evaluate(tr_loss, model, trial, epoch, False)
